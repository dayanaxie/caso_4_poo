...
public class RobotWarFrame extends JFrame {
	...
	private int xTrampaU;
	private int yTrampaU;
	private int xTrampaD;
	private int yTrampaD;
	...
	public void InstanciarTrampas() {
	    ...
	    Image modTrampaU = trampaU.getScaledInstance(90,90, Image.SCALE_SMOOTH);
	    this.trampaU = new ImageIcon(modTrampaU).getImage();
	    
	    this.trampaD = new ImageIcon(ruta + "fuego.png").getImage();
	    Image modTrampaD = trampaD.getScaledInstance(90,90, Image.SCALE_SMOOTH);
	    this.trampaD = new ImageIcon(modTrampaD).getImage();
	...
	public void paint(Graphics g){
		...
		g2D.drawImage(robot, xRobot, yRobot, 200, 200, null);
		g2D.drawImage(trampaU, xTrampaU, yTrampaU, 300, 300,null);
		g2D.drawImage(trampaD, xTrampaD, yTrampaD, 215, 180,null);
		g2D.drawRect(10, 40, 120, 750);
		g2D.drawRect(130, 40, 1070, 100);
		g2D.drawRect(130, 685, 1070, 100);
	}
